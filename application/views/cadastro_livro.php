    ...
    <div class="fundo_cad_edit_livro">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url('cadastrar_livro') ?>">
            <fieldset>
                ...
                <a href="<?php echo base_url('cad_referente_livro/1') ?>">Novo autor não cadastrado...</a>
                ...
                <a href="<?php echo base_url('cad_referente_livro/2') ?>">Novo gênero não cadastrado...</a>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="qt_exemplar" name="qt_exemplar" type="number" min='1' placeholder="" class="form-control input-md" required="">
